...
export const FIXTURE_SEGMENTS: TranscriptSegment[] = [
  ...
  { id: "segment_7", startMs: 30500, endMs: 36000, text: "Okay. Let's check your blood pressure and go from there.", speakerId: "speaker_1" },
  { id: "segment_8", startMs: 36500, endMs: 38000, text: "Sounds good.", speakerId: null },
];
